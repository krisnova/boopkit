...
//    }
    ...
    //
    // Note: This is a connectionless SYN packet over SOCK_RAW which allows us to do our dirty work.
    //
    ...
    char* packet;
    int packet_len;
    // TODO: @kris-nova We should spam a few bad checksum ports! We know we can send to any TCP port on the server!
